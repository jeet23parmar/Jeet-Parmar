...
if choice == "N" or choice == "n":
  accessToken = input("ZDI5NTcyNGUtOWNiNi00YzIwLTk2YWEtMjZiZDg2ZjZhM2Q0OWU1ZjhjN2MtNjE5_PC75_f1a9c66d-3eff-454d-9c51-a4e0afcd770b")
  accessToken = "Bearer " + accessToken
else:
	accessToken = "Bearer ZDI5NTcyNGUtOWNiNi00YzIwLTk2YWEtMjZiZDg2ZjZhM2Q0OWU1ZjhjN2MtNjE5_PC75_f1a9c66d-3eff-454d-9c51-a4e0afcd770b"
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "JbdYc4136TY9vf7DGg5MInFYdgNVKDJI" 
                               }
# 7. Provide the URL to the MapQuest GeoCode API.
        r = requests.get("https://www.mapquestapi.com/geocoding/v1/address?key= JbdYc4136TY9vf7DGg5MInFYdgNVKDJI&location=Sudbury,ON", 
